			...
			<ul>
				<li>
					<article>
						...
						<details>
							<summary>
								Ver todos los cursos y certificaciones de Platzi
							</summary>
							<ul>
		...
		<section>
			...
			<ul>
				<li>
					<article>
						<h4>
							Propietario en Stone Drinks (Bar), Guatapé, Antioquia, Colombia
						</h4>
						<p>Marzo 2021 - Presente</p>
						<ul>
							<li>
								Desarrolle e implemente contenidos para el sitio web de la
								empresa.
							</li>
				...
				<li>
					<article>
						...
						<ul>
							<li>
								Planifiqué e impartí clases practicas de desarrollo a
								estudiantes del curso de programación de Guatapé donde al
								finalizar el curso pudieron desarrollar el Frontend completo de
								una aplicación
							</li>
						</ul>
					</article>
